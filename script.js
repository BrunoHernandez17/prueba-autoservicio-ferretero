...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.category-card, .service-card, .brand-item, .feature, .stat-item');
...
document.querySelectorAll('.social-icon').forEach(icon => {
    icon.addEventListener('mouseenter', function() {
        const platform = this.querySelector('i').className.includes('facebook') ? 'Facebook' :
                        ...
                        this.querySelector('i').className.includes('linkedin') ? 'LinkedIn' : 'Red Social';
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('Autoservicio Ferretero San Miguel - Website loaded successfully!');
